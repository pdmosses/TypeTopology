...
# from the `dev` branch of the Agda-Material repo (2026-03-27).

# MAIN CHANGES
# The Makefile has been edited as follows to generate a TypeTopology website:
# - variables DIR, ROOT, HTML, MD, INDEX: custom values
# - target gen-html: copy assets/Agda.css, and call docs/updatehtml
# - targets clean-html, clean-md: automatic removal of outdated files
...
.PHONY: serve
serve:
	@NO_MKDOCS_2_WARNING=1 mkdocs serve --livereload --dev-addr localhost:8010
