...
# make web                            68 seconds
# make serve                          66 seconds

# DEPLOY A GENERATED WEBSITE:         97 seconds
# make deploy
...
# The official TypeTopology website uses the non-standard assets/Agda.css,
# which is copied to the HTML directory.
...
# TypeTopology: make debug

# DIR:     source
# ROOT:    AllModulesIndex
# PROJECT: /Users/pdm/Projects/Agda/TypeTopology

# INCLUDE-PATHS:  source
# ROOT-PATHS:      AllModulesIndex
# ROOT-FILES:    source/AllModulesIndex.lagda